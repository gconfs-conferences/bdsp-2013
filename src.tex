...
\newcommand{\tptitle}
    {\textbf{TP BDSP 13/14} $\bullet$ Tés triste $\bullet$ \textbf{GConfs}}
...
\newpage
	...
	\begin{itemize}
		...
		envoyer les changements appliqués à votre dépôt local au
		dépôt distant d'un seul coup.\\
	...
	La deuxième méthode a l'avantage de vous permettre dénvoyer d'un
	seul coup le résultat de plusieurs commits d'affilée sur le
	dépôt distant. \\
	Choisissez le dépôt et la branche sur lequel \textbf{\emph{push}}
	puis appuyez sur \textbf{\emph{Push}}, entrez votre password
	\textbf{Bitbucket} ou \textbf{GitHub} selon le site sur lequel vous
	avez créé un compte, puis attendez. Ça ne devrait pas être très
	long.\\
 
    \item Maintenant que votre code se trouve sur le dépôt distant, vos
	coéquipiers peuvent cloner ce dépôt depuis votre service de
	hosting préféré. Pour ça aussi il devrait y avoir un gros bouton
	prévu à cet effet.\\
